...
var VideoRow = React.createClass({displayName: "VideoRow",
...
var App = React.createClass({displayName: "App",
  ...
  render: function() {
    var urls = this.state.URLs.map(function(url){
      return (
        React.createElement(VideoRow, {url: url, key: url.id, onClick: this.videoRowClickHandler})
      );
    }, this);
    return (
      React.createElement("div", null, 
        ...
        React.createElement("div", {className: "video-container", id: "videoContainer1"}), 
        React.createElement("div", {className: "video-container", id: "videoContainer2"}), 
        React.createElement("div", {className: "video-container", id: "videoContainer3"})
      )
    );
  }
});
...
},{"./VideoRow.jsx":148,"react":147}]},{},[148,149]);
